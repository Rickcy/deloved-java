...
<head>
    ...
    <title><g:message code="org.list.label"/></title>
</head>

<body>
<div id="list-currency" class="content scaffold-list" role="main">

    <h1><g:message code="org.list.label"/></h1>

    <g:render template="/_common/flash-message"/>

    <div class="buttons">
        <g:link class="btn btn-success" action="create"><g:message code="org.button.new.label"/></g:link>
        ...
        <div class="btn-group">
            ...
            <ul class="dropdown-menu" role="menu">
                <li><a href="#" onclick="return batchDelete();"><g:message code="org.button.delete.label"/></a></li>
            </ul>
        </div>
    </div>

    <g:form url="[controller: 'org', action: 'index']">
        <div class="row">
    ...
    <g:form id="batch_form" url="[controller: 'org', action: 'batch']" method="POST">
        ...
        <div class="table-responsive">
            <table border="0" class="table table-striped table-hover">
                ...
                <tbody>
                <g:each in="${orgFormInstanceList}" status="i" var="obj">
