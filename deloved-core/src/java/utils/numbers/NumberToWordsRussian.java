...
//				3 * MILLIARD * MILLIARD,
//		};
//		NumberToWordsRussian toWords = new NumberToWordsRussian();
//		for (long value : values) {
//			System.out.println(toWords.toWords(value));
//		}
//		System.out.println(toWords.toWords(new BigDecimal(938000).multiply(
//
//
//				new BigDecimal(MILLIARD * MILLIARD))));
//		System.out.println(toWords.toWords(new BigDecimal(MILLION).multiply(
//
//
//				new BigDecimal(MILLIARD * MILLIARD))));
//		System.out.println(toWords.toWords(new BigDecimal(MILLIARD).multiply(
//
//
//				new BigDecimal(MILLIARD * MILLIARD))));
//	}
