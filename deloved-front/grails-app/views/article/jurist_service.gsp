...
<head>
    ...
    <title><g:titleContent code="TDKContentJuristService"/></title>
    <g:descKeyContent code="TDKContentJuristService"/>
    <style>
    .shadow_block{
        position: relative;
...
<div class="shadow_block">
    ...
    <h2 class="h2_main_name" style="font-weight: bold;text-align:left!important;color:rgb(148, 196, 61)"><img style="min-width:40px;width: 6%;margin-left: 3%;margin-right: 3%" src="${resource(dir: 'images', file: 'front/icon_jurist.png')}"/>ЮРИДИЧЕСКАЯ СЛУЖБА
        <div style="background-image: linear-gradient(270deg, rgb(248, 215, 53), rgb(148, 196, 61) 110%);
        width: 98%;
        height: 4px;"></div></h2>
    <div class="img-responsive">
        <img src="${resource(dir: 'images', file: 'front/jurist.jpg')}" style="width: 90%;margin: 0 5%;border-radius: 30px"/>
    </div>
<div class="row">
    <div style="margin-top: 3%">
        <div class="col-sm-6" style="font-size: 15pt;padding-top: 5%">

            <g:contContentColumn1 code="TDKContentJuristService"/>
...
<div class="row">
    <div style="margin-top: 3%">
        <div class="col-sm-6 col-sm-push-6"  style="font-size: 15pt;padding-top: 5%">
            <g:contContentColumn2 code="TDKContentJuristService"/>
