...
<head>
	...
	<asset:javascript src="servecesInd.js"></asset:javascript>
...
<div class="row">
	...
	<div class="col-md-6 col-lg-6 ndblock" style="position: relative;left: 25%;min-height: 700px">
		...
		<g:if test="${categoryFilterData.company}">
			Услуги предприятия <g:link url="[controller: 'company', id: categoryFilterData.company.id]">${categoryFilterData.company.name}</g:link>
		</g:if>
		<g:if test="${categoryFilterData.category}">
		...
		<g:else>
			<h1 class="text-center" style="padding-bottom: 15px">Услуги</h1>
...
<g:if test="${mainServices.size()>2	}">
	<g:if test="${!mainServices.isEmpty()}">
