...
class gsp_delovedApp_loginauth_gsp extends GroovyPage {
...
invokeTag('link','g',5,['controller':("signup"),'action':("index")],1)
printHtmlPart(3)
...
invokeTag('link','g',11,['controller':("recover")],1)
printHtmlPart(7)
...
printHtmlPart(10)
invokeTag('message','g',15,['code':("springSecurity.login.remember.me.label")],-1)
printHtmlPart(11)
invokeTag('message','g',18,['code':("springSecurity.login.button")],-1)
printHtmlPart(12)
}
...
public static final long LAST_MODIFIED = 1484900880610L
