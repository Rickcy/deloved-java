...
class gsp_delovedAdmin__common_edit_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/plugins/deloved-admin-0.1/grails-app/views/_common/_edit.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(9)
invokeTag('render','g',14,['template':(formTemplate ?: 'form')],-1)
printHtmlPart(10)
...
public static final long LAST_MODIFIED = 1473927890040L
