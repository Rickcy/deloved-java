...
class gsp_delovedAdmin_contenteditform2_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/plugins/deloved-admin-0.1/grails-app/views/content/editform2.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(11)
invokeTag('render','g',22,['template':("form2")],-1)
printHtmlPart(12)
})
...
public static final long LAST_MODIFIED = 1473922234080L
