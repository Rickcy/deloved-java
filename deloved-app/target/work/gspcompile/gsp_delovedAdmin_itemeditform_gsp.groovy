...
class gsp_delovedAdmin_itemeditform_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/plugins/deloved-admin-0.1/grails-app/views/item/editform.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('formRemote','g',24,['name':("editForm"),'update':("myModalContent"),'url':([resource: beanResource, action: 'update']),'class':("form-horizontal"),'style':("overflow: hidden"),'onFailure':("alert(textStatus)")],1)
printHtmlPart(14)
...
public static final long LAST_MODIFIED = 1458035456059L
